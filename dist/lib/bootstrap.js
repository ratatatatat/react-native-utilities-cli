...
export const createApp = async (baseDir) => {
...
const installNavigation = async (baseDir) => {
...
const setupScreens = (baseDir, baseScreens) => {
...
const getScreenFileContent = (screen) => {
...
const getRouteFileContent = (screen) => {
