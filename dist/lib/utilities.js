...
export const createComponent = async (baseDir, componentName) => {
...
export const createScaffolding = (baseDir) => {
    const directories = [
        './src',
        './src/redux',
        './src/redux/slices',
...
const createDirectoriesIfNotExist = (directories) => {
...
export const installRedux = (baseDir) => {
    const reduxPackages = [
        '@reduxjs/toolkit',
        'react-redux',
    ];
...
export const setupRedux = (baseDir) => {
    const baseslices = [
        'signup',
        'login',
        'logout',
...
const getStoreFileContent = (slices) => {
...
const setupReduxSlices = (baseDir, baseslices) => {
...
const getSliceFileContent = (slice) => {
